export const CHANNEL_OPTIONS = [
  ...
  {key: 24, text: 'Gemini', value: 24, color: 'orange'},
  {
    ...
    value: 51,
    color: 'orange',
    description: 'Gemini in OpenAI-compatible format',
  },
  ...
  { key: 46, text: 'Replicate', value: 46, color: 'blue' },
  {
    ...
    value: 8,
    color: 'pink',
    tip: 'Not recommended. Use <strong>OpenAI Compatible</strong> instead. This proxy address only replaces the domain at request time. If you need an SDK-style Base URL, use the OpenAI Compatible type.',
    description: 'Not recommended. Prefer OpenAI Compatible channel type.',
  },
